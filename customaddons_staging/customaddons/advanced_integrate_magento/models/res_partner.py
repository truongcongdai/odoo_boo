...
class ResPartner(models.Model):
    ...
    def get_record_to_sync_rank(self):
        ...
        ).filtered(lambda partner: len(partner.phone) > 0 and partner.customer_ranked and partner.sale_order_count > 0)
    ...
    def _cron_sync_customer_loyalty_point_to_magento(self):
        loyalty_point_ids = self.env['s.customer.loyalty.points'].sudo().search([('type_points','=','reward')], limit=1000)
