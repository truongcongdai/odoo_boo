    ...
    def _format_sale_order_data(domain, limit, offset):
        ...
        if sale_order_obj:
            ...
            for sale_order in sale_order_ids:
                            ...
                            if r.product_id.detailed_type == 'product':
                                ...
                                if r.product_uom_qty < 0:
                                    if sale_order.sale_order_status == 'hoan_thanh_1_phan' and sale_order.date_order >= datetime.strptime(
                                        ...
                                        s_chanel_discount += -(r.s_chanel_discount * r.qty_delivered / r.product_uom_qty)
                                        s_crm_discount += -(r.s_crm_discount * r.qty_delivered / r.product_uom_qty)
                                        s_hr_discount += -(r.s_hr_discount * r.qty_delivered / r.product_uom_qty)
                                        ...
                                        s_chanel_discount += -r.s_chanel_discount
                                        s_crm_discount += -r.s_crm_discount
                                        s_hr_discount += -r.s_hr_discount
                                        if sale_order.is_magento_order:
                ...
                order_type = 'Order'
                if sale_order.sale_order_status == 'huy':
                    order_type = 'Cancel'
                elif sale_order.sale_order_status != 'huy' and (sale_order.is_return_order or sale_order.return_order_id):
                    order_type = 'Return'
                ...
                res.append({
                    ...
                    'chanel_discount': s_chanel_discount,
                    'crm_discount': s_crm_discount,
                    'hr_discount': s_hr_discount,
                    'total_discount_percentage': s_chanel_discount + s_crm_discount + s_hr_discount,
