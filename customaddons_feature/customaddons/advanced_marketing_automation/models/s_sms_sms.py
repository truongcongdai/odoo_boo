                                    ...
                                    if participant.resource_ref:
                                        if participant.resource_ref._name == 'pos.order':
                                            ...
                                            data['template_data'].update({
                                                ...
                                                'customer_rank': participant.resource_ref.partner_id.customer_ranked if participant.resource_ref.partner_id else "",
                                                'total_period_revenue': participant.resource_ref.partner_id.total_period_revenue if participant.resource_ref.partner_id else 0,
                                                'points_increased': participant.resource_ref.loyalty_points if participant.resource_ref.loyalty_points else 0,
                                                'order_date': str(
