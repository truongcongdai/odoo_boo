...
#
#
# # API point-history-search Vani
#
#
# class PointsHistorySearchVani(http.Controller):
#     @validate_integrate_token
#     @http.route('/points-history-search', type='json', auth='none', methods=['POST'], csrf=False)
#     def points_history_search(self, **kwargs):
#         try:
...
#                                                     for result in result_message:
#                                                         if result.get('transactionId'):
#                                                             if len(history_line.order_id.refunded_order_ids)>0 and int(result.get('transactionId')) == history_line.order_id.refunded_order_ids[0].id:
#                                                                 result.update({
#                                                                     'transactionStatus': 'CANCELLATION'
#                                                                 })
#                                             else:
